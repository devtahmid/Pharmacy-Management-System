...
<body id="page-top">
    <nav class="navbar navbar-dark bg-secondary navbar-expand-xl ">
        <a class="navbar-brand font-weight-bold col" href="./pharmacist_home.php">Pharmacy Management System</a>
        ...
        <div class="collapse navbar-collapse col" id="navbarTogglerDemo02">
            ...
            <ul class="navbar-nav col mt-2 mt-xl-0">
                <li class="nav-item">
                    <a class="nav-link text-white pl-3" href="addmedicine.php">Add Stock<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white pl-3" href="expired_stock.php">Expired Stock<span class="sr-only">(current)</span></a>
                </li>

                <li class="nav-item ml-xl-auto">
                    <a class="nav-link text-white pl-3" href="viewOrders.php">Order<span class="sr-only">(current)</span></a>
                </li>
